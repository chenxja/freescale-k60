...
#define __VECTORS_H     1
    ...
    //extern PDB_isr(void);
    extern void DMA_CHO_ISR(void);
    //extern portd_isr(void);
    ...
    #define VECTOR_016      DMA_CHO_ISR     // 0x0000_0040 16     0     DMA              DMA Channel 0 transfer complete
    ...
    #define VECTOR_103       porta_isr      // 0x0000_019C 103   87     Port control module Pin Detect (Port A)
    #define VECTOR_104       portb_isr      // 0x0000_01A0 104   88     Port control module Pin Detect (Port B)
