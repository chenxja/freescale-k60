          ...
          case 1:
            {
              ...
              Servo_P_zhidao+=1;
              LCD_P6x8Str_3(72,3,Servo_P_zhidao); 
            } break;    
          case 9:
            {
              while(KeyValue==9)
              ...
              Servo_D_zhidao+=1;
              LCD_P6x8Str_3(92,3,Servo_D_zhidao)  ; 
              break; 
            }
          case 5:
            {
    ...
    case 2:
      {
        ...
        //Servo_P_zhidao
          if(sai_dao_number==0){LCD_CLS2(3);LCD_P6x8Str(0,3,"Mid_Wu");LCD_P6x8Str_3(72,3,Servo_P_zhidao); LCD_P6x8Str_3(92,3,Servo_D_zhidao);zhidao_Wu();}        //14
        if(sai_dao_number==1){LCD_CLS2(3);LCD_P6x8Str(0,3,"Mid_Wu");LCD_P6x8Str_3(72,3,P_Low); LCD_P6x8Str_3(92,3,D_Low);Mid_Wu();}        //14
        if(sai_dao_number==2){LCD_CLS2(3);LCD_P6x8Str(0,3,"High_Wu");LCD_P6x8Str_3(72,3,P_Mid); LCD_P6x8Str_3(92,3,D_Mid);High_Wu();} 
        if(sai_dao_number==3){LCD_CLS2(3);LCD_P6x8Str(0,3,"High_You");LCD_P6x8Str_3(72,3,P_High); LCD_P6x8Str_3(92,3,D_High);High_You();}  
  ...
  while(!car_speed_flag)
  {
    ...
    case 5:
      ...
      case 6:
      {
        ...
        speed_cut_timer-=10;
        LCD_P6x8Str_3(100,1,speed_cut_timer);
        //print_d1(sai_dao_number);
      }break;
       ...
       case 10:
      {
        ...
        start_startline+=10;
        LCD_P6x8Str_3(100,7,start_startline);
        //print_d1(sai_dao_number);
      }break;
